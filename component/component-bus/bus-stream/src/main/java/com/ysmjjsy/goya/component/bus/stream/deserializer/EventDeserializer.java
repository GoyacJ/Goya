...
public class EventDeserializer {
        ...
        if (eventTypeName != null && !eventTypeName.isBlank()) {
            ...
            if (whitelist != null && !whitelist.isAllowed(eventTypeName)) {
                ...
                try {
                    ...
                    Class<? extends IBusEvent> eventType = (Class<? extends IBusEvent>) Class.forName(eventTypeName);
     ...
     */
    private IBusEvent deserializeToEventType(Object payload, Class<? extends IBusEvent> targetType) {
        try {
            String json = convertPayloadToString(payload);
            if (json == null || json.isBlank()) {
                return null;
            }
            return GoyaJson.fromJson(json, targetType);
        } catch (Exception e) {
    ...
    private String convertPayloadToString(Object payload) {
        return switch (payload) {
            ...
            default -> GoyaJson.toJson(payload);
        };
