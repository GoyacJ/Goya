...
public class RandomProvider {
     ...
     * 常用言责
     */
    private static final int[][] COLOR = {{0, 135, INT}, {51, 153, 51}, {INT, 102, 102}, {INT, 153, 0}, {153, 102, 0}, {153, 102, 153}, {51, 153, 153}, {102, 102, INT}, {0, 102, 204}, {204, 51, 51}, {0, 153, 204}, {0, 51, 102}};
    ...
    private static String randomCharacter(CaptchaCharacterEnum captchaCharacter) {
        return CHARACTERS[randomInt(captchaCharacter.getStart(), captchaCharacter.getEnd())];
    }

    public static String[] randomCharacters(int number, CaptchaCharacterEnum captchaCharacter) {
        List<String> characters = IntStream.range(0, number).mapToObj(i -> randomCharacter(captchaCharacter)).toList();
