...
public class TimeJacksonComponent {
    ...
    private static final DateTimeFormatter FORMATTER_HHMMSS = DateTimeFormatter.ofPattern(IBaseConstants.DATE_FORMAT_HHMMSS);
        ...
        public LocalDateTime deserialize(JsonParser p, DeserializationContext ctxt) throws JacksonException {
            ...
            try {
                ...
                log.warn("[Goya] |- LocalDateTime 反序列化失败: {}, 格式应为: {}",
                        dateTimeStr, IBaseConstants.DATE_FORMAT_YYYY_MM_DD_HH_MM_SS);
                throw new JsonException(
                        "日期时间格式错误，应为: " + IBaseConstants.DATE_FORMAT_YYYY_MM_DD_HH_MM_SS, e);
            }
        }
    }
        ...
        public LocalDate deserialize(JsonParser p, DeserializationContext ctxt) throws JacksonException {
            ...
            try {
                ...
                log.warn("[Goya] |- LocalDate 反序列化失败: {}, 格式应为: {}",
                        dateStr, IBaseConstants.DATE_FORMAT_YYYY_MM_DD);
                throw new JsonException(
                        "日期格式错误，应为: " + IBaseConstants.DATE_FORMAT_YYYY_MM_DD, e);
            }
        }
    }
