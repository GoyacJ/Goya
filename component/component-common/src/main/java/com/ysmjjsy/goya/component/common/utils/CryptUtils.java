...
public class CryptUtils {
    ...
    public static String createSm4key() {
        ...
        String result = Hex.toHexString(key);
        log.trace("[GOYA] |- SM4 crypto create hex key, value is : [{}]", result);
        return result;
    }
    ...
    public static String decryptRsa(String content, String privateKey) {
        try {
            ...
            log.trace("[GOYA] |- RSA crypto decrypt data, value is : [{}]", res);
            return res;
        } catch (Exception e) {
    ...
    public static String encryptRsa(String content, String publicKey) {
        try {
            ...
            log.trace("[GOYA] |- RSA crypto encode data, value is : [{}]", result);
            return result;
        } catch (Exception e) {
    ...
    public static String decryptSm4(String content, String publicKey) {
        try {
            ...
            log.trace("[GOYA] |- SM4 crypto decrypt result is : [{}]", result);
            return result;
        } catch (Exception e) {
    ...
    public static String encryptSm4(String content, String publicKey) {
        try {
            ...
            String result = Hex.toHexString(out);
            log.trace("[GOYA] |- SM4 crypto encrypt result is : [{}]", result);
            return result;
        } catch (Exception e) {
