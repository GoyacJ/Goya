...
public class StreamUtils {
    ...
    public static <E> String join(Collection<E> collection, Function<E, String> function) {
        return join(collection, function, ISymbolConstants.COMMA);
    }
    ...
    public static List<String> merge(List<String> appendResources, List<String> defaultResources) {
        if (org.apache.commons.collections4.CollectionUtils.isEmpty(appendResources)) {
            return defaultResources;
        } else {
            return org.apache.commons.collections4.CollectionUtils.collate(defaultResources, appendResources);
        }
    }
