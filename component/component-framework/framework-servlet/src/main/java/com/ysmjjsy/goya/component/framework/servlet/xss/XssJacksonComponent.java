...
import com.ysmjjsy.goya.component.framework.servlet.utils.XssUtils;
    ...
    public static class XssDeserializer extends ValueDeserializer<String> {
        ...
        public String deserialize(JsonParser p, DeserializationContext ctx) throws JacksonException {
            ...
            try {
                ...
                throw Exceptions.system(CommonErrorCode.SYSTEM_ERROR).cause(e).userMessage("Xss 反序列化错误").build();
            }
        }
    }
}
