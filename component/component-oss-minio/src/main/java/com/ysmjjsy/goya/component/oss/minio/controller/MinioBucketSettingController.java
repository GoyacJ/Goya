 ...
 */
@RestController
@RequestMapping(DefaultConst.DEFAULT_PROJECT_NAME + "/oss/minio/bucket/setting")
...
public class MinioBucketSettingController implements IController {
    ...
    @GetMapping
    public ApiRes<BucketSettingBusiness> get(@RequestParam(value = "bucketName") String bucketName) {
