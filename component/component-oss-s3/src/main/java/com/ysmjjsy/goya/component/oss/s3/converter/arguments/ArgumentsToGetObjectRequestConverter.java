...
import com.ysmjjsy.goya.component.framework.oss.arguments.object.GetObjectArguments;
...
/**
 * <p>统一定义 GetObjectArguments 转 S3 GetObjectRequest 转换器</p>
 *
 * @author goya
 * @since 2023/8/14 22:00
 */
public class ArgumentsToGetObjectRequestConverter implements Converter<GetObjectArguments, GetObjectRequest> {
    
    @Override
    public GetObjectRequest convert(GetObjectArguments source) {
