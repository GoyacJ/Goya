...
public interface IRedisService {
     ...
     */
    <K> boolean tryLock(K key, long waitTime, long leaseTime, TimeUnit unit) throws InterruptedException;
     ...
     * @throws IllegalArgumentException 如果 key 为 null
     */
    <K> long incrementBy(K key, long delta);
     ...
     */
    <K> int append(K key, String value);
     ...
     * @throws IllegalArgumentException 如果 key 为 null 或参数无效
     */
    <K> boolean expire(K key, long time, TimeUnit unit);
     ...
     */
    <K> int addToList(K key, Object... values);
     ...
     * @throws IllegalArgumentException 如果 key 为 null
     */
    <K, V> V getFromList(K key, int index);
     ...
     * @throws IllegalArgumentException 如果 key 为 null 或 values 为 null
     */
    <K> int addToSet(K key, Object... values);
     ...
     * @throws IllegalArgumentException 如果 key 或 value 为 null
     */
    <K> boolean containsInSet(K key, Object value);
     ...
     * @throws IllegalArgumentException 如果 key 为 null
     */
    <K, V> RScoredSortedSet<V> getSortedSet(K key);
     ...
     * @throws IllegalArgumentException 如果 key 或 value 为 null
     */
    <K> boolean addToSortedSet(K key, double score, Object value);
     ...
     * @throws IllegalArgumentException 如果 key 为 null
     */
    <K, V> Collection<V> getSortedSetRange(K key, int startRank, int endRank);
     ...
     */
    <K> void setHashField(K key, Object field, Object value);
     ...
     */
    <K, V> V getHashField(K key, Object field);
     ...
     * @throws IllegalArgumentException 如果 key 为 null
     */
    <N, K, V> Map<K, V> getHashAll(N key);
